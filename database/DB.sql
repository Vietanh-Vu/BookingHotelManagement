...
VALUES
    -- User 1-10
    ('James', 'Smith', 'james.smith@example.com', '5556667777', '123 Oak Avenue', 0, 'password1'),
    ('Emma', 'Johnson', 'emma.johnson@example.com', '4445556666', '456 Pine Road', 0, 'password2'),
    ('Olivia', 'Williams', 'olivia.williams@example.com', '6665554444', '789 Elm Street', 0, 'password3'),
    ('Noah', 'Jones', 'noah.jones@example.com', '5554443333', '321 Oak Avenue', 0, 'password4'),
    ('Sophia', 'Brown', 'sophia.brown@example.com', '2223334444', '654 Maple Lane', 0, 'password5'),
    ('Liam', 'Davis', 'liam.davis@example.com', '4443332222', '987 Elm Street', 0, 'password6'),
    ('Ava', 'Miller', 'ava.miller@example.com', '5556667777', '234 Pine Road', 0, 'password7'),
    ('William', 'Wilson', 'william.wilson@example.com', '1112223333', '567 Oak Avenue', 0, 'password8'),
    ('Isabella', 'Moore', 'isabella.moore@example.com', '4445556666', '890 Cedar Street', 0, 'password9'),
    ('Logan', 'Taylor', 'logan.taylor@example.com', '6665554444', '123 Pine Road', 0, 'password10'),
    -- User 11-20
    ('Sophia', 'Anderson', 'sophia.anderson@example.com', '5554443333', '456 Cedar Street', 0, 'password11'),
    ('Jackson', 'Thomas', 'jackson.thomas@example.com', '2223334444', '789 Elm Street', 0, 'password12'),
    ('Olivia', 'Jackson', 'olivia.jackson@example.com', '4443332222', '321 Oak Avenue', 0, 'password13'),
    ('Aiden', 'White', 'aiden.white@example.com', '5556667777', '654 Maple Lane', 0, 'password14'),
    ('Mia', 'Harris', 'mia.harris@example.com', '1112223333', '987 Elm Street', 0, 'password15'),
    ('Lucas', 'Clark', 'lucas.clark@example.com', '4445556666', '234 Pine Road', 0, 'password16'),
    ('Layla', 'Lewis', 'layla.lewis@example.com', '6665554444', '567 Oak Avenue', 0, 'password17'),
    ('Liam', 'Lee', 'liam.lee@example.com', '5556667777', '890 Cedar Street', 0, 'password18'),
    ('Harper', 'Hall', 'harper.hall@example.com', '7778889999', '123 Pine Road', 0, 'password19'),
    ('Elijah', 'Young', 'elijah.young@example.com', '5554443333', '456 Cedar Street', 0, 'password20'),
    -- User 21-30
    ('Avery', 'King', 'avery.king@example.com', '2223334444', '789 Elm Street', 0, 'password21'),
    ('Scarlett', 'Baker', 'scarlett.baker@example.com', '4443332222', '321 Oak Avenue', 0, 'password22'),
    ('Sofia', 'Gonzalez', 'sofia.gonzalez@example.com', '5556667777', '654 Maple Lane', 0, 'password23'),
    ('Henry', 'Nelson', 'henry.nelson@example.com', '1112223333', '987 Elm Street', 0, 'password24'),
    ('Mila', 'Carter', 'mila.carter@example.com', '4445556666', '234 Pine Road', 0, 'password25'),
    ('Sebastian', 'Garcia', 'sebastian.garcia@example.com', '6665554444', '567 Oak Avenue', 0, 'password26'),
    ('Leah', 'Foster', 'leah.foster@example.com', '5556667777', '890 Cedar Street', 0, 'password27'),
    ('Carter', 'Hill', 'carter.hill@example.com', '7778889999', '123 Pine Road', 0, 'password28'),
    ('Elizabeth', 'Adams', 'elizabeth.adams@example.com', '5554443333', '456 Cedar Street', 0, 'password29'),
    ('Daniel', 'Turner', 'daniel.turner@example.com', '2223334444', '789 Elm Street', 0, 'password30'),
    -- User 31-40
    ('Victoria', 'Campbell', 'victoria.campbell@example.com', '4443332222', '321 Oak Avenue', 0, 'password31'),
    ('Jack', 'Perez', 'jack.perez@example.com', '5556667777', '654 Maple Lane', 0, 'password32'),
    ('Grace', 'Hernandez', 'grace.hernandez@example.com', '1112223333', '987 Elm Street', 0, 'password33'),
    ('Michael', 'Morgan', 'michael.morgan@example.com', '4445556666', '234 Pine Road', 0, 'password34'),
    ('Penelope', 'Allen', 'penelope.allen@example.com', '6665554444', '567 Oak Avenue', 0, 'password35'),
    ('Benjamin', 'Cook', 'benjamin.cook@example.com', '5556667777', '890 Cedar Street', 0, 'password36'),
    ('Nora', 'Rossi', 'nora.rossi@example.com', '7778889999', '123 Pine Road', 0, 'password37'),
    ('Leo', 'Russo', 'leo.russo@example.com', '5554443333', '456 Cedar Street', 0, 'password38'),
    ('Madison', 'Romano', 'madison.romano@example.com', '2223334444', '789 Elm Street', 0, 'password39'),
    ('Jacob', 'Lombardi', 'jacob.lombardi@example.com', '4443332222', '321 Oak Avenue', 0, 'password40'),
    -- User 41-50
    ('Luna', 'Esposito', 'luna.esposito@example.com', '5556667777', '654 Maple Lane', 0, 'password41'),
    ('Ethan', 'Conti', 'ethan.conti@example.com', '1112223333', '987 Elm Street', 0, 'password42'),
    ('Chloe', 'Galli', 'chloe.galli@example.com', '4445556666', '234 Pine Road', 0, 'password43'),
    ('Alexander', 'Marino', 'alexander.marino@example.com', '6665554444', '567 Oak Avenue', 0, 'password44'),
    ('Aria', 'De Angelis', 'aria.deangelis@example.com', '5556667777', '890 Cedar Street', 0, 'password45'),
    ('Joseph', 'Ferrari', 'joseph.ferrari@example.com', '7778889999', '123 Pine Road', 0, 'password46'),
    ('Ella', 'Barbieri', 'ella.barbieri@example.com', '5554443333', '456 Cedar Street', 0, 'password47'),
    ('David', 'Marchetti', 'david.marchetti@example.com', '2223334444', '789 Elm Street', 0, 'password48'),
    ('Aubrey', 'De Santis', 'aubrey.desantis@example.com', '4443332222', '321 Oak Avenue', 0, 'password49'),
    ('Christopher', 'Guerra', 'christopher.guerra@example.com', '5556667777', '654 Maple Lane', 0, 'password50'),
    -- User 51-60
    ('Aaliyah', 'Pellegrini', 'aaliyah.pellegrini@example.com', '1112223333', '987 Elm Street', 0, 'password51'),
    ('Gabriel', 'Martini', 'gabriel.martini@example.com', '4445556666', '234 Pine Road', 0, 'password52'),
    ('Abigail', 'Serra', 'abigail.serra@example.com', '6665554444', '567 Oak Avenue', 0, 'password53'),
    ('Andrew', 'Bellini', 'andrew.bellini@example.com', '5556667777', '890 Cedar Street', 0, 'password54'),
    ('Alyssa', 'Cesari', 'alyssa.cesari@example.com', '7778889999', '123 Pine Road', 0, 'password55'),
    ('Julian', 'Monaco', 'julian.monaco@example.com', '5554443333', '456 Cedar Street', 0, 'password56'),
    ('Natalie', 'Rinaldi', 'natalie.rinaldi@example.com', '2223334444', '789 Elm Street', 0, 'password57'),
    ('Levi', 'De Luca', 'levi.deluca@example.com', '4443332222', '321 Oak Avenue', 0, 'password58'),
    ('Brooklyn', 'Messina', 'brooklyn.messina@example.com', '5556667777', '654 Maple Lane', 0, 'password59'),
    ('Henry', 'Guadagnino', 'henry.guadagnino@example.com', '1112223333', '987 Elm Street', 0, 'password60'),
    -- User 61-70
    ('Audrey', 'Ferretti', 'audrey.ferretti@example.com', '4445556666', '234 Pine Road', 0, 'password61'),
    ('Ryan', 'Parisi', 'ryan.parisi@example.com', '6665554444', '567 Oak Avenue', 0, 'password62'),
    ('Claire', 'Santoro', 'claire.santoro@example.com', '5556667777', '890 Cedar Street', 0, 'password63'),
    ('John', 'Gatti', 'john.gatti@example.com', '7778889999', '123 Pine Road', 0, 'password64'),
    ('Skylar', 'Valenti', 'skylar.valenti@example.com', '5554443333', '456 Cedar Street', 0, 'password65'),
    ('Julian', 'Ferraro', 'julian.ferraro@example.com', '2223334444', '789 Elm Street', 0, 'password66'),
    ('Samantha', 'Silvestri', 'samantha.silvestri@example.com', '4443332222', '321 Oak Avenue', 0, 'password67'),
    ('Nathan', 'Palumbo', 'nathan.palumbo@example.com', '5556667777', '654 Maple Lane', 0, 'password68'),
    ('Hannah', 'Monteleone', 'hannah.monteleone@example.com', '1112223333', '987 Elm Street', 0, 'password69'),
    ('Jonathan', 'Marchetti', 'jonathan.marchetti@example.com', '4445556666', '234 Pine Road', 0, 'password70'),
    -- User 71-80
    ('Lily', 'Palmieri', 'lily.palmieri@example.com', '6665554444', '567 Oak Avenue', 0, 'password71'),
    ('Wyatt', 'Colombo', 'wyatt.colombo@example.com', '5556667777', '890 Cedar Street', 0, 'password72'),
    ('Addison', 'Bianco', 'addison.bianco@example.com', '7778889999', '123 Pine Road', 0, 'password73'),
    ('Christopher', 'De Angelis', 'christopher.deangelis@example.com', '5554443333', '456 Cedar Street', 0, 'password74'),
    ('Sofia', 'Vitale', 'sofia.vitale@example.com', '2223334444', '789 Elm Street', 0, 'password75'),
    ('Grayson', 'Caruso', 'grayson.caruso@example.com', '4443332222', '321 Oak Avenue', 0, 'password76'),
    ('Arianna', 'De Santis', 'arianna.desantis@example.com', '5556667777', '654 Maple Lane', 0, 'password77'),
    ('Joshua', 'Rizzo', 'joshua.rizzo@example.com', '1112223333', '987 Elm Street', 0, 'password78'),
    ('Victoria', 'Donati', 'victoria.donati@example.com', '4445556666', '234 Pine Road', 0, 'password79'),
    ('Henry', 'Giordano', 'henry.giordano@example.com', '6665554444', '567 Oak Avenue', 0, 'password80'),
    -- User 81-90
    ('Layla', 'Rossi', 'layla.rossi@example.com', '5556667777', '890 Cedar Street', 0, 'password81'),
    ('James', 'Ferri', 'james.ferri@example.com', '7778889999', '123 Pine Road', 0, 'password82'),
    ('Elizabeth', 'Benedetti', 'elizabeth.benedetti@example.com', '5554443333', '456 Cedar Street', 0, 'password83'),
    ('Benjamin', 'Marino', 'benjamin.marino@example.com', '2223334444', '789 Elm Street', 0, 'password84'),
    ('Savannah', 'Ricci', 'savannah.ricci@example.com', '4443332222', '321 Oak Avenue', 0, 'password85'),
    ('Caleb', 'Lombardi', 'caleb.lombardi@example.com', '5556667777', '654 Maple Lane', 0, 'password86'),
    ('Lillian', 'De Rosa', 'lillian.derosa@example.com', '1112223333', '987 Elm Street', 0, 'password87'),
    ('Samuel', 'Russo', 'samuel.russo@example.com', '4445556666', '234 Pine Road', 0, 'password88'),
    ('Gabriella', 'Ferrante', 'gabriella.ferrante@example.com', '6665554444', '567 Oak Avenue', 0, 'password89'),
    ('Daniel', 'DAmico', 'daniel.damico@example.com', '5556667777', '890 Cedar Street', 0, 'password90'),
    -- User 91-100
    ('Sofia', 'Battaglia', 'sofia.battaglia@example.com', '7778889999', '123 Pine Road', 0, 'password91'),
    ('Joseph', 'Rinaldi', 'joseph.rinaldi@example.com', '5554443333', '456 Cedar Street', 0, 'password92'),
    ('Amelia', 'Guerra', 'amelia.guerra@example.com', '2223334444', '789 Elm Street', 0, 'password93'),
    ('Michael', 'Marini', 'michael.marini@example.com', '4443332222', '321 Oak Avenue', 0, 'password94'),
    ('Emily', 'Caruso', 'emily.caruso@example.com', '5556667777', '654 Maple Lane', 0, 'password95'),
    ('Daniel', 'Barone', 'daniel.barone@example.com', '1112223333', '987 Elm Street', 0, 'password96'),
    ('Scarlett', 'Valentini', 'scarlett.valentini@example.com', '4445556666', '234 Pine Road', 0, 'password97'),
    ('Mason', 'Battaglia', 'mason.battaglia@example.com', '6665554444', '567 Oak Avenue', 0, 'password98'),
    ('Victoria', 'Bianchi', 'victoria.bianchi@example.com', '5556667777', '890 Cedar Street', 0, 'password99'),
    ('Alexander', 'Leone', 'alexander.leone@example.com', '7778889999', '123 Pine Road', 0, 'password100');
